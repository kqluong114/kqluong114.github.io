import { IoLocationSharp, IoLogoLinkedin, IoMail, IoLogoGithub } from "react-icons/io5";
    ...
    <section id="profile" className="py-10">
      ...
      <div className="flex flex-col m-auto justify-center align-middle">
        ...
        <div className="flex justify-center gap-1 flex-wrap">
          ...
          <div className="flex gap-1 items-center">
            <IoLogoGithub />
            <a className="text-blue-400" href="https://github.com/kqluong114">@Kqluong114</a>
            <GoDotFill className="text-pink-400" />
            </div>
          <div className="flex gap-1 items-center">
            <IoLogoLinkedin />
            <a className="text-blue-400" href="linkedin.com/in/khanh-luong-4471561a1">/in/Khanh-Luong</a>
          </div>
        </div>
